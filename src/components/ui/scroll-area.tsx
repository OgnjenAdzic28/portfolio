  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Thumb
        ...
        className={cn(
          // Use the host theme's foreground token so the thumb remains visible
          // in both of the portfolio's color schemes.
          "relative bg-foreground/10 transition-[background-color,width,height] duration-160 ease-in-out",
          "group-hover/scrollbar:bg-foreground/20 active:!bg-foreground/30",
          shape.bg,
