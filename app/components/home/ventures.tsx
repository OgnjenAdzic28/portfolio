          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-6 mt-4">
            ...
            >
              <VentureCard
                ...
                title="ALFRED"
                subtitle="Co-founder of ALFRED — Redefining Assistance with the First True AI Butler"
            ...
            >
              <VentureCard
                ...
                title="Pingless"
                subtitle="Founder at Pingless — Websites That Actually Work."
            ...
            >
              <VentureCard
                ...
                title="ArchiStella"
                subtitle="Co-founder of ArchiStella — B2B marketplace for the maritime industry."
            ...
            >
              <VentureCard
                ...
                title="Maritime@Penn"
                subtitle="Co-creator of Maritime@Penn — Club connecting UPenn with the maritime industry."
